...
hours = ["when are you guys open", "what are your hours", "hours of operation","time","work time"
,"time period"]
print("*******************************************************\n")
while True:
a = input('User said -')
...
botans = ["My name is TVC bot","You can call me TVC bot","TVC Bot in your service",
"My friends call me TVC Bot"]
print('Bot said -'+ random.choice(botans)+'\n')
elif a.lower() in bye:
